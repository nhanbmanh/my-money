              ...
              <Popover open={actionMenuOpen} onOpenChange={setActionMenuOpen}>
                ...
                >
                  <button
                    ...
                    className="w-full flex items-start gap-2.5 p-2.5 rounded-xl hover:bg-sky-50 dark:hover:bg-slate-800/80 text-left transition-all group"
                  >
                  ...
                  <button
                    ...
                    className="w-full flex items-start gap-2.5 p-2.5 rounded-xl hover:bg-emerald-50 dark:hover:bg-slate-800/80 text-left transition-all group"
                  >

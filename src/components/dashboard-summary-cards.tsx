...
export function DashboardSummaryCards({
  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3 shrink-0">
      {/* Total Income */}
      <Card className="bg-white/90 dark:bg-slate-900/90 backdrop-blur border border-emerald-100 dark:border-emerald-900/40 shadow-xs hover:shadow-sm transition-shadow rounded-xl">
        <CardContent className="p-2.5 sm:px-4 sm:py-3 flex items-center justify-between">
          <div className="min-w-0 flex-1">
            <p className="text-[10px] sm:text-[11px] font-semibold uppercase tracking-wider text-emerald-600 dark:text-emerald-400 mb-0.5 truncate">
              Thu nhập
            </p>
      ...
      {/* Total Expense */}
      <Card className="bg-white/90 dark:bg-slate-900/90 backdrop-blur border border-rose-100 dark:border-rose-900/40 shadow-xs hover:shadow-sm transition-shadow rounded-xl">
        <CardContent className="p-2.5 sm:px-4 sm:py-3 flex items-center justify-between">
          <div className="min-w-0 flex-1">
            <p className="text-[10px] sm:text-[11px] font-semibold uppercase tracking-wider text-rose-600 dark:text-rose-400 mb-0.5 truncate">
              Chi tiêu
            </p>
      ...
      {/* Net Balance */}
      <Card className="bg-white/90 dark:bg-slate-900/90 backdrop-blur border border-sky-100 dark:border-sky-900/40 shadow-xs hover:shadow-sm transition-shadow rounded-xl">
        <CardContent className="p-2.5 sm:px-4 sm:py-3 flex items-center justify-between">
          <div className="min-w-0 flex-1">
            <p className="text-[10px] sm:text-[11px] font-semibold uppercase tracking-wider text-sky-600 dark:text-sky-400 mb-0.5 truncate">
              Số dư
            </p>
            <h3
